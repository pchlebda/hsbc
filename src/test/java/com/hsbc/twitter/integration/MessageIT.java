...
public class MessageIT {
    ...
    void shouldAddMessage() {
        ...
        messagePost.setUsername("Damian");
        ...
        MessagePost[] messagePosts = restTemplate.getForObject(postUrl + "/Damian", MessagePost[].class);

        //then
        assertThat(entity.getStatusCode()).isEqualTo(HttpStatus.CREATED);
        assertThat(messagePosts.length).isEqualTo(1);
        assertThat(messagePosts[0]).extracting(MessagePost::getUsername).isEqualTo("Damian");
